...
<img src="http://proof.roaet.com/images/Shiny-Stacked-Rocks.jpg" align="left"/>
...
<ul>
  ...
  <li>If your domU setup isn't properly working even though the install succeeded, it is possible that the openstack developers have updated to a point where the automation fails. Zenstack developers intend on trying to keep up with such changes but if you beat us to it contact us about the issue, or fork it!
</ul>
