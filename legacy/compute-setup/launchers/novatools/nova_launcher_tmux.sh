...
# Open mysql
# -----------------------------------------------------------
tmux new-session -s $TMUX_SESSION_NAME -d -n "db" "mysql -uroot nova"
...
texec "./bin/glance-manage db_sync"
texec "./bin/glance-api"
splitwindow
changedir $GLANCE_DIR
texec "source .venv/bin/activate"
texec "./bin/glance-registry"
splitwindow
changedir $GLANCE_DIR
texec "source .venv/bin/activate"
evenpanes
