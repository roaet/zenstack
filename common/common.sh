#!/bin/bash
SETUP_XEN_USERNAME="YOUR-XEN-USERNAME"
SETUP_XEN_PASSWORD="YOUR-XEN-PASSWORD"
SETUP_DB_USERNAME="YOUR-DB-USERNAME"
SETUP_DB_PASSWORD="YOUR-DB-PASSWORD"
SETUP_XEN_IP="YOUR-XEN-IP"
SETUP_VM_USERNAME="YOUR-USERNAME"
